...
| 15| [Andrew the Ant](./problems/andrewant) | 4.8 | Time Limit Exceeded [6] | [C++](./problems/andrewant/main.cpp) | Probably I try to insert duplicate timestamps to the time queue (which is a `set`) |
